...
const (
	SampleService_SampleHandler_FullMethodName = "/api.SampleService/SampleHandler"
)
...
type SampleServiceClient interface {
	SampleHandler(ctx context.Context, in *SampleRequest, opts ...grpc.CallOption) (*SampleResponse, error)
}
...
func (c *sampleServiceClient) SampleHandler(ctx context.Context, in *SampleRequest, opts ...grpc.CallOption) (*SampleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SampleResponse)
	err := c.cc.Invoke(ctx, SampleService_SampleHandler_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SampleServiceServer interface {
	SampleHandler(context.Context, *SampleRequest) (*SampleResponse, error)
...
func (UnimplementedSampleServiceServer) SampleHandler(context.Context, *SampleRequest) (*SampleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SampleHandler not implemented")
}
...
func _SampleService_SampleHandler_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SampleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SampleServiceServer).SampleHandler(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SampleService_SampleHandler_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).SampleHandler(ctx, req.(*SampleRequest))
	}
...
var SampleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SampleHandler",
			Handler:    _SampleService_SampleHandler_Handler,
		},
	},
